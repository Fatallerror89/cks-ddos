...
def chk():
  ...
  try:
    httpCaht = requests.get("https://txt.do/1fgnw/raw").text
    httpBand = requests.get("https://txt.do/tsmeh/raw").text
    if id in httpBand:
      print("Your ID is Banned......")
      
      msg = "THIS ID BANNED"+str(os.geteuid())
      ...
      print("\x1b[31;1mYOUR ID IS NOT ACTIVE.........")
      time.sleep(4)
      sys.exit()
  except:
    sys.exit()
